        ...
        <>
            ...
            <div className="w-full h-fit px-5 md:px-12 lg:px-28 py-16 space-y-16">
                <div className="flex items-center gap-3 justify-between w-full">
                    ...
                    <div className="relative w-full max-w-[500px] h-[300px] overflow-hidden rounded-tr-[150px] rounded-bl-[130px] rounded-tl-[90px] rounded-br-[40px] shadow-[-25px_25px_0px_-15px_rgba(0,0,0,0.3)]">
                        <Image
                            src="/assets/company1.jpg"
                            alt="company"
                            fill
                            className="size-full absolute filter brightness-90"
                        />
                    </div>
                </div>
                <div className="flex items-center gap-3 justify-between w-full">
                    <div className="relative w-full max-w-[500px] h-[300px] overflow-hidden rounded-tr-[100px] rounded-bl-[95px] rounded-tl-[120px] rounded-br-[60px] shadow-[-25px_25px_0px_-15px_rgba(0,0,0,0.3)]">
                        <Image
